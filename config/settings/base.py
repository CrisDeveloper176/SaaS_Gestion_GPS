"""
Django base settings for fleet_backend project.
"""
...
# Email settings (Console backend for dev/dummy as per Phase 5)
...
SIMPLE_JWT = {
    ...
    'AUTH_TOKEN_CLASSES': ('apps.authentication.tokens.TenantAccessToken',),
}

SPECTACULAR_SETTINGS = {
    'TITLE': 'Fleet Management API',
    'DESCRIPTION': 'SaaS Multi-tenant REST API',
    'VERSION': '1.1.0',
